...
class SavedPlaceViewController: NiblessViewController {
    ...
    private let viewModel: SavedPlaceViewViewModelType
    ...
    // MARK: - Initialization
    init(viewModel: SavedPlaceViewViewModelType) {
...
extension SavedPlaceViewController: UITableViewDelegate {
